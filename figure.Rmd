...
plot_demographics <- function(in_df) {
    ...
    plt <- (df <- in_df %>%
        ...
        facet_grid("Continent~.", scales = "free", space = "free_y", switch = "y") +
...
combined_plot <- plot_demographics(combined_df)

write.csv2(combined_df, "./data/combined_demographics.csv", quote=FALSE, row.names=FALSE)
