...
plot_grid(plt, right_col, labels = c('A', ''), label_size = 12, ncol = 2, rel_widths = c(2, 1))

ggsave("./figures/composite_fig.pdf", device="pdf", height = 11, width=9, unit="in", limitsize = FALSE)
ggsave("./figures/composite_fig.png", device="png", height = 11, width=9, unit="in", limitsize = FALSE)
```
